...
const Var varEnergyRecoB([](const caf::SRSliceProxy* slc) -> double {
  double E_Nu = varEnergyReco(slc) + varErecNeutron(slc);
  return E_Nu;
});
...
const Var varEnergyResB([](const caf::SRSliceProxy* slc) -> double {
  double E_Nu_Reco = varEnergyRecoB(slc);
  double E_Nu_True = varNeutrinoTruthE(slc);
  double E_Nu_Res = E_Nu_Reco - E_Nu_True;
  return E_Nu_Res;
});
...
// DATA FILES
// newest file
void EnergyRecoStudy_Nu(const std::string inputName = "IcarusProd2021B_BNB_Nu_Cosmics_v09_28_01_01_01_caf")

// rangeP-fixed CAFS
//void EnergyRecoStudy_Nu(const std::string inputName = "/pnfs/icarus/scratch/users/jskim/mc/SBNworkshopApril2021__corsika_numu_BNB/CAF/sbncode__v09_27_00_02_FixRangeProton/48388331_*/gen*.root")

// one file
//void EnergyRecoStudy_Nu(const std::string inputName = "/pnfs/icarus/persistent/users/icaruspro/SBNworkshopApril2021/CAF/corsika_nue_BNB/0/0/caf-01608068-6435-4a36-93b5-29ead574d963.root")

// twenty-one files
//void EnergyRecoStudy_Nu(const std::string inputName = "/pnfs/icarus/persistent/users/icaruspro/SBNworkshopApril2021/CAF/corsika_nue_BNB/0/0/*.root")
...
// Binning
  ...
  Spectrum sEnergyReco("Neutrino Energy (GeV)", bins2, loader, varEnergyReco, kNoSpillCut, cutNuMu);
  Spectrum sEnergyReco1("Neutrino Energy (GeV)", bins2, loader, varEnergyReco1, kNoSpillCut, cutNuMu);
  Spectrum sEnergyReco2("Neutrino Energy (GeV)", bins2, loader, varEnergyReco2, kNoSpillCut, cutNuMu);
  Spectrum sEnergyReco3("Neutrino Energy (GeV)", bins2, loader, varEnergyReco3, kNoSpillCut, cutNuMu);
  Spectrum sEnergyRecoB("Neutrino Energy (GeV)", bins2, loader, varEnergyRecoB, kNoSpillCut, cutNuMu);
  Spectrum sEnergyReco1b("Neutrino Energy (GeV)", bins2, loader, varEnergyReco1b, kNoSpillCut, cutNuMu);
  Spectrum sEnergyReco2b("Neutrino Energy (GeV)", bins2, loader, varEnergyReco2b, kNoSpillCut, cutNuMu);
  Spectrum sEnergyReco3b("Neutrino Energy (GeV)", bins2, loader, varEnergyReco3b, kNoSpillCut, cutNuMu);

  Spectrum sEnergyTrue("Etrue, all events", bins2, loader, varNeutrinoTruthE, kNoSpillCut, cutNuMu);
  Spectrum sEnergyTrue1("Etrue, 1 trk and 0 shws", bins2, loader, varNeutrinoTruthE1, kNoSpillCut, cutNuMu);
  Spectrum sEnergyTrue2("Etrue, 2 trks and 0 shws", bins2, loader, varNeutrinoTruthE2, kNoSpillCut, cutNuMu);
  Spectrum sEnergyTrue3("Etrue, all other events", bins2, loader, varNeutrinoTruthE3, kNoSpillCut, cutNuMu);
  ...
  Spectrum sRecoTrue2D(loader, axEtrue, axEreco, kNoSpillCut, cutNuMu);
  Spectrum sRecoTrue2Db(loader, axEtrue, axErecoB, kNoSpillCut, cutNuMu);
  ...
  Spectrum sRecoTrue2D_1(loader, axEtrue1, axEreco1, kNoSpillCut, cutNuMu);
  Spectrum sRecoTrue2D_1b(loader, axEtrue1, axEreco1b, kNoSpillCut, cutNuMu);
  ...
  Spectrum sRecoTrue2D_2(loader, axEtrue2, axEreco2, kNoSpillCut, cutNuMu);
  Spectrum sRecoTrue2D_2b(loader, axEtrue2, axEreco2b, kNoSpillCut, cutNuMu);
  ...
  Spectrum sRecoTrue2D_3(loader, axEtrue3, axEreco3, kNoSpillCut, cutNuMu);
  Spectrum sRecoTrue2D_3b(loader, axEtrue3, axEreco3b, kNoSpillCut, cutNuMu);

  Spectrum sEnergyRes("Residual Neutrino Energy (GeV)", bins3, loader, varEnergyRes, kNoSpillCut, cutNuMu);
  Spectrum sEnergyRes1("Residual Neutrino Energy (GeV)", bins3, loader, varEnergyRes1, kNoSpillCut, cutNuMu);
  Spectrum sEnergyRes2("Residual Neutrino Energy (GeV)", bins3, loader, varEnergyRes2, kNoSpillCut, cutNuMu);
  Spectrum sEnergyRes3("Residual Neutrino Energy (GeV)", bins3, loader, varEnergyRes3, kNoSpillCut, cutNuMu);
  Spectrum sEnergyResB("Residual Neutrino Energy (GeV)", bins3, loader, varEnergyResB, kNoSpillCut, cutNuMu);
  Spectrum sEnergyRes1b("Residual Neutrino Energy (GeV)", bins3, loader, varEnergyRes1b, kNoSpillCut, cutNuMu);
  Spectrum sEnergyRes2b("Residual Neutrino Energy (GeV)", bins3, loader, varEnergyRes2b, kNoSpillCut, cutNuMu);
  Spectrum sEnergyRes3b("Residual Neutrino Energy (GeV)", bins3, loader, varEnergyRes3b, kNoSpillCut, cutNuMu);

  const HistAxis axEres("Residual Energy", bins7, varEnergyRes);
  const HistAxis axEresB("Residual Energy", bins7, varEnergyResB);
  Spectrum sResTrue2D(loader, axEtrue, axEres, kNoSpillCut, cutNuMu);
  Spectrum sResTrue2Db(loader, axEtrue, axEresB, kNoSpillCut, cutNuMu);

  const HistAxis axEres1("Residual Energy", bins7, varEnergyRes1);
  const HistAxis axEres1b("Residual Energy", bins7, varEnergyRes1b);
  Spectrum sResTrue2D_1(loader, axEtrue1, axEres1, kNoSpillCut, cutNuMu);
  Spectrum sResTrue2D_1b(loader, axEtrue1, axEres1b, kNoSpillCut, cutNuMu);

  const HistAxis axEres2("Residual Energy", bins7, varEnergyRes2);
  const HistAxis axEres2b("Residual Energy", bins7, varEnergyRes2b);
  Spectrum sResTrue2D_2(loader, axEtrue2, axEres2, kNoSpillCut, cutNuMu);
  Spectrum sResTrue2D_2b(loader, axEtrue2, axEres2b, kNoSpillCut, cutNuMu);

  const HistAxis axEres3("Residual Energy", bins7, varEnergyRes3);
  const HistAxis axEres3b("Residual Energy", bins7, varEnergyRes3b);
  Spectrum sResTrue2D_3(loader, axEtrue3, axEres3, kNoSpillCut, cutNuMu);
  Spectrum sResTrue2D_3b(loader, axEtrue3, axEres3b, kNoSpillCut, cutNuMu);
  ...
  Spectrum sPtransEres2D(loader, axPtrans, axEres, kNoSpillCut, cutNuMu);
  Spectrum sPtransEres2Db(loader, axPtrans, axEresB, kNoSpillCut, cutNuMu);
  Spectrum sPtransEres2D_1(loader, axPtrans1, axEres1, kNoSpillCut, cutNuMu);
  Spectrum sPtransEres2D_1b(loader, axPtrans1, axEres1b, kNoSpillCut, cutNuMu);
  Spectrum sPtransEres2D_2(loader, axPtrans2, axEres2, kNoSpillCut, cutNuMu);
  Spectrum sPtransEres2D_2b(loader, axPtrans2, axEres2b, kNoSpillCut, cutNuMu);
  Spectrum sPtransEres2D_3(loader, axPtrans3, axEres3, kNoSpillCut, cutNuMu);
  Spectrum sPtransEres2D_3b(loader, axPtrans3, axEres3b, kNoSpillCut, cutNuMu);
  ...
  leg1->Draw();
  c1->Print("EnergyRecoStudy_Nu/Ereco.png");
  ...
  c2->Print("EnergyRecoStudy_Nu/RecoTrue2D.png");
  ...
  c14->Print("EnergyRecoStudy_Nu/RecoTrue2Db.png");
  ...
  leg3->Draw();
  c3->Print("EnergyRecoStudy_Nu/Eres.png");
  ...
  c13->Print("EnergyRecoStudy_Nu/ResTrue2D.png");
  ...
  c15->Print("EnergyRecoStudy_Nu/ResTrue2Db.png");
  ...
  gr1->Draw("AP");
  c33->Print("EnergyRecoStudy_Nu/AvgEres.png");
  ...
  gr2->Draw("AP");
  c34->Print("EnergyRecoStudy_Nu/AvgEresb.png");
  ...
  leg41->Draw();
  c41->Print("EnergyRecoStudy_Nu/Scatter1.png");
  ...
  c25->Print("EnergyRecoStudy_Nu/PtransEres2D.png");
  ...
  c26->Print("EnergyRecoStudy_Nu/PtransEres2Db.png");
  ...
  leg4->Draw();
  c4->Print("EnergyRecoStudy_Nu/Ereco1.png");
  ...
  c5->Print("EnergyRecoStudy_Nu/RecoTrue2D_1.png");
  ...
  c17->Print("EnergyRecoStudy_Nu/RecoTrue2D_1b.png");
  ...
  leg6->Draw();
  c6->Print("EnergyRecoStudy_Nu/Eres1.png");
  ...
  c16->Print("EnergyRecoStudy_Nu/ResTrue2D_1.png");
  ...
  c18->Print("EnergyRecoStudy_Nu/ResTrue2D_1b.png");
  ...
  gr3->Draw("AP");
  c35->Print("EnergyRecoStudy_Nu/AvgEres1.png");
  ...
  gr4->Draw("AP");
  c36->Print("EnergyRecoStudy_Nu/AvgEres1b.png");
  ...
  leg42->Draw();
  c42->Print("EnergyRecoStudy_Nu/Scatter2.png");
  ...
  c27->Print("EnergyRecoStudy_Nu/PtransEres2D_1.png");
  ...
  c28->Print("EnergyRecoStudy_Nu/PtransEres2D_1b.png");
  ...
  leg7->Draw();
  c7->Print("EnergyRecoStudy_Nu/Ereco2.png");
  ...
  c8->Print("EnergyRecoStudy_Nu/RecoTrue2D_2.png");
  ...
  c20->Print("EnergyRecoStudy_Nu/RecoTrue2D_2b.png");
  ...
  leg9->Draw();
  c9->Print("EnergyRecoStudy_Nu/Eres2.png");
  ...
  c19->Print("EnergyRecoStudy_Nu/ResTrue2D_2.png");
  ...
  c21->Print("EnergyRecoStudy_Nu/ResTrue2D_2b.png");
  ...
  gr5->Draw("AP");
  c37->Print("EnergyRecoStudy_Nu/AvgEres2.png");
  ...
  gr6->Draw("AP");
  c38->Print("EnergyRecoStudy_Nu/AvgEres2b.png");
  ...
  leg43->Draw();
  c43->Print("EnergyRecoStudy_Nu/Scatter3.png");
  ...
  c29->Print("EnergyRecoStudy_Nu/PtransEres2D_2.png");
  ...
  c30->Print("EnergyRecoStudy_Nu/PtransEres2D_2b.png");
  ...
  leg10->Draw();
  c10->Print("EnergyRecoStudy_Nu/Ereco3.png");
  ...
  c11->Print("EnergyRecoStudy_Nu/RecoTrue2D_3.png");
  ...
  c23->Print("EnergyRecoStudy_Nu/RecoTrue2D_3b.png");
  ...
  leg12->Draw();
  c12->Print("EnergyRecoStudy_Nu/Eres3.png");
  ...
  c22->Print("EnergyRecoStudy_Nu/ResTrue2D_3.png");
  ...
  c24->Print("EnergyRecoStudy_Nu/ResTrue2D_3b.png");
  ...
  gr7->Draw("AP");
  c39->Print("EnergyRecoStudy_Nu/AvgEres3.png");
  ...
  gr8->Draw("AP");
  c40->Print("EnergyRecoStudy_Nu/AvgEres3b.png");
  ...
  leg44->Draw();
  c44->Print("EnergyRecoStudy_Nu/Scatter4.png");
  ...
  c31->Print("EnergyRecoStudy_Nu/PtransEres2D_3.png");
  ...
  c32->Print("EnergyRecoStudy_Nu/PtransEres2D_3b.png");
}
